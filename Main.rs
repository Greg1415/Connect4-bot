use std::io;
/*
    Macro provided by CodinGame
    Inputs provided by CodinGame will never fail to parse,
    so the use of unwrap() is acceptable
*/
...
/*
    "Main" is basically interface between the sovler and CodinGame.
    Most of this code was auto-generated by CodinGame. 
    It is extremely ugly, but it works, so I don't care too much.
*/
fn main() {
    ...
    loop {
        ...
        /*
            Codingame's connect 4 has a special rule.
            If the opponent's first move is in the middle column,
            you can print "STEAL" to replace his piece with your piece.
            
            Therefore, the second player should write "STEAL" if the first
            player plays in the center, and the first player should
            avoid playing there. 
            
            This behavior is hardcoded here.
        */
        if turn_index == 0 {
            println!("3");
...
impl BitBoard{
    ...
    // Bitwise operators really shine here
